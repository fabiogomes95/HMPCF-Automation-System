...
```powershell
$PG_PASSWORD   = "***REMOVIDO***"
```

Você pode trocar `***REMOVIDO***` pela senha que preferir, ou deixar como está.
...
> Substitua `***REMOVIDO***` pela senha que você definiu no Passo 5, se tiver trocado.
